      ...
      case "state":
        const getStateInfo = () => {
          const stateRates: Record<string, { rate: number; name: string }> = {
            ...
            'AZ': { rate: 4.5, name: 'Arizona' },
            'AR': { rate: 5.5, name: 'Arkansas' },
            'CA': { rate: 8.0, name: 'California' },
            'CO': { rate: 4.55, name: 'Colorado' },
            'CT': { rate: 6.0, name: 'Connecticut' },
            'DE': { rate: 5.5, name: 'Delaware' },
            'FL': { rate: 0.0, name: 'Florida' },
            'GA': { rate: 5.5, name: 'Georgia' },
            'HI': { rate: 7.5, name: 'Hawaii' },
            'ID': { rate: 5.5, name: 'Idaho' },
            'IL': { rate: 4.95, name: 'Illinois' },
            'IN': { rate: 3.23, name: 'Indiana' },
            'IA': { rate: 6.5, name: 'Iowa' },
            'KS': { rate: 5.5, name: 'Kansas' },
            'KY': { rate: 5.0, name: 'Kentucky' },
            'LA': { rate: 4.5, name: 'Louisiana' },
            'ME': { rate: 7.5, name: 'Maine' },
            'MD': { rate: 5.5, name: 'Maryland' },
            'MA': { rate: 5.0, name: 'Massachusetts' },
            'MI': { rate: 4.25, name: 'Michigan' },
            'MN': { rate: 7.5, name: 'Minnesota' },
            'MS': { rate: 5.0, name: 'Mississippi' },
            'MO': { rate: 5.5, name: 'Missouri' },
            'MT': { rate: 6.5, name: 'Montana' },
            'NE': { rate: 6.5, name: 'Nebraska' },
            'NV': { rate: 0.0, name: 'Nevada' },
            'NH': { rate: 0.0, name: 'New Hampshire' },
            'NJ': { rate: 6.5, name: 'New Jersey' },
            'NM': { rate: 5.5, name: 'New Mexico' },
            'NY': { rate: 6.5, name: 'New York' },
            'NC': { rate: 5.25, name: 'North Carolina' },
            'ND': { rate: 4.5, name: 'North Dakota' },
            'OH': { rate: 4.5, name: 'Ohio' },
            'OK': { rate: 5.0, name: 'Oklahoma' },
            'OR': { rate: 8.5, name: 'Oregon' },
            'PA': { rate: 3.07, name: 'Pennsylvania' },
            'RI': { rate: 5.5, name: 'Rhode Island' },
            'SC': { rate: 6.0, name: 'South Carolina' },
            'SD': { rate: 0.0, name: 'South Dakota' },
            'TN': { rate: 0.0, name: 'Tennessee' },
            'TX': { rate: 0.0, name: 'Texas' },
            'UT': { rate: 4.95, name: 'Utah' },
            'VT': { rate: 7.5, name: 'Vermont' },
            'VA': { rate: 5.5, name: 'Virginia' },
            'WA': { rate: 0.0, name: 'Washington' },
            'WV': { rate: 5.5, name: 'West Virginia' },
            'WI': { rate: 6.5, name: 'Wisconsin' },
